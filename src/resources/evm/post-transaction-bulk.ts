...
export type PostTransactionBulkScanResponse =
  Array<PostTransactionBulkScanResponse.PostTransactionBulkScanResponseItem>;

export namespace PostTransactionBulkScanResponse {
  export interface PostTransactionBulkScanResponseItem {
    block: string;
    ...
    events?: Array<PostTransactionBulkScanResponseItem.Event>;

    features?: unknown;

    gas_estimation?:
      | PostTransactionBulkScanResponseItem.RoutersEvmModelsTransactionScanGasEstimation
      | PostTransactionBulkScanResponseItem.RoutersEvmModelsTransactionScanGasEstimationError;

    simulation?:
      | PostTransactionBulkScanResponseItem.RoutersEvmResponseTransactionSimulation
      | PostTransactionBulkScanResponseItem.RoutersEvmResponseTransactionSimulationError;

    user_operation_gas_estimation?:
      | PostTransactionBulkScanResponseItem.RoutersEvmModelsUserOperationV6GasEstimation
      | PostTransactionBulkScanResponseItem.RoutersEvmModelsUserOperationV7GasEstimation
      | PostTransactionBulkScanResponseItem.RoutersEvmModelsTransactionScanGasEstimationError;

    validation?:
      | PostTransactionBulkScanResponseItem.RoutersEvmResponseTransactionValidation
      | PostTransactionBulkScanResponseItem.RoutersEvmResponseTransactionValidationError;
  }

  export namespace PostTransactionBulkScanResponseItem {
...
export interface PostTransactionBulkScanParams {
   ...
   */
  metadata:
    | PostTransactionBulkScanParams.RoutersEvmModelsMetadataNonDapp
    | PostTransactionBulkScanParams.RoutersEvmModelsMetadataDapp;
   ...
   */
  state_override?: { [key: string]: PostTransactionBulkScanParams.StateOverride };
}
