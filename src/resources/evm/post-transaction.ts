...
export class PostTransaction extends APIResource {
   ...
   * ```
   */
  report(body: PostTransactionReportParams, options?: RequestOptions): APIPromise<unknown> {
...
export interface PostTransactionScanResponse {
  ...
  events?: Array<PostTransactionScanResponse.Event>;

  features?: unknown;

  gas_estimation?:
    | PostTransactionScanResponse.RoutersEvmModelsTransactionScanGasEstimation
    | PostTransactionScanResponse.RoutersEvmModelsTransactionScanGasEstimationError;

  simulation?:
    | PostTransactionScanResponse.RoutersEvmResponseTransactionSimulation
  ...
  validation?:
    | PostTransactionScanResponse.RoutersEvmResponseTransactionValidation
    | PostTransactionScanResponse.RoutersEvmResponseTransactionValidationError;
}
...
export interface PostTransactionScanParams {
  ...
  transaction_hints?: Array<
    PostTransactionScanParams.CrossChainBridgeHint | PostTransactionScanParams.GenericTransactionHint
  >;
}
