...
export class TransactionRaw extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.evm.transactionRaw.scan({
   *   account_address:
...
export interface TransactionRawScanResponse {
  ...
  events?: Array<TransactionRawScanResponse.Event>;

  features?: unknown;

  gas_estimation?:
    | TransactionRawScanResponse.RoutersEvmModelsTransactionScanGasEstimation
    | TransactionRawScanResponse.RoutersEvmModelsTransactionScanGasEstimationError;

  simulation?:
    | TransactionRawScanResponse.RoutersEvmResponseTransactionSimulation
    | TransactionRawScanResponse.RoutersEvmResponseTransactionSimulationError;

  user_operation_gas_estimation?:
    | TransactionRawScanResponse.RoutersEvmModelsUserOperationV6GasEstimation
    | TransactionRawScanResponse.RoutersEvmModelsUserOperationV7GasEstimation
    | TransactionRawScanResponse.RoutersEvmModelsTransactionScanGasEstimationError;

  validation?:
    | TransactionRawScanResponse.RoutersEvmResponseTransactionValidation
    | TransactionRawScanResponse.RoutersEvmResponseTransactionValidationError;
}
