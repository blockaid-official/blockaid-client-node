...
export interface TransactionScanResponse {
  simulation?:
    | TransactionScanResponse.TransactionSimulation
    | TransactionScanResponse.TransactionSimulationError;

  validation?:
    | TransactionScanResponse.TransactionValidation
    | TransactionScanResponse.TransactrionValidationError;
}
