...
export interface JsonRpcScanParams {
  ...
  transaction_hints?: Array<
    JsonRpcScanParams.CrossChainBridgeHint | JsonRpcScanParams.GenericTransactionHint
  >;
}
...
export declare namespace JsonRpc {
  export { type JsonRpcScanResponse as JsonRpcScanResponse, type JsonRpcScanParams as JsonRpcScanParams };
}
