...
export interface JsonRpcScanResponse {
  simulation?: JsonRpcScanResponse.TransactionSimulation | JsonRpcScanResponse.TransactionSimulationError;

  validation?: JsonRpcScanResponse.TransactionValidation | JsonRpcScanResponse.TransactrionValidationError;
}
